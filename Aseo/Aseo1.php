...
<head>
    ...
    <title>PROG5A - Equipo 1 de aseo</title>
...
<body onload="getLocation();">
    ...
    <div>
        <p class="Descripción-Artículo">
            <?php
            echo ("Un gusto tenerte por aquí, " . $_SESSION['Nombre'] . ". Aquí tienes los integrantes del equipo 1.");
            ?>
        </p>
        <!--
    ...
    -->
        <table class="InsertarResultados Examen">
            <?php
            $consulta = "SELECT * FROM `usuarios_prog5a` WHERE `EquipoAseo`=1";
